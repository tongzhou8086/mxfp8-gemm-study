...
Tier: bn512-single-tmem-ns4
Config: BM=128 BN=512 BK=64 NS=4 GROUP_SIZE_M=8 NUM_WARPS=4 PERSISTENT=1 EPILOGUE_OVERLAP=1 EPILOGUE_SPLIT=0 EPILOGUE_L1_NO_ALLOC=0 EPILOGUE_TMA_PIPELINED=1 TMA_STORE_STAGES=2 SINGLE_TMEM_ACCUM=1
