# BN256 MXFP8 CUDA Raw-TMA Store-2 Variant

This is the explicit two-TMA-store-stage companion to
`../bn256-mxfp8-cuda-raw-tma`.  It keeps the same kernel structure but sets
`TMA_STORE_STAGES=2`, so the epilogue SMEM store ring cycles across two
buffers.
